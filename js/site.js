...
(function ($) {
  ...
  $(window).scroll(function () {
    if ($(window).scrollTop() > 100) {
      $('.header').addClass('header--desktop-fixed');
    }
    else{
      $('.header').removeClass('header--desktop-fixed');
    }
  });

  $(".js-input").focusin(function() {
      $(this).closest(".form__group").find(".form__label").addClass("form__label--floated");
  });

  $(".js-input").focusout(function() {
      if( !$(this).val() ) {
        $(this).closest(".form__group").find(".form__label").removeClass("form__label--floated");
      }
  });
  ...
  $(".js-form-contact").validate({
    messages: {
      ...
      _replyto: "Fill out with a valid e-mail",
      assunto: "Please type a subject",
      body: "Where's the message? :)",
    },
  ...
  $(".js-form-contact-en").validate({
    messages: {
      name: "This field is required",
      _replyto: "This field is required",
      assunto: "This field is required",
      body: "Where is the message? :)",
    },
    submitHandler: function(form) {
      form.submit();
    }
...
if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent)
  ...
  $('.hamburger-menu').on('click', function() {
    ...
    $('.js-menu').toggleClass("header__nav--active");
  })
